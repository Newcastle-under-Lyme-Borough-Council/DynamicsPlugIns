...
namespace SS.MSDYN.LGIntelliware.Plugins
{
    public class PostTaxiLicence : PluginBase
    {
        ...
        protected void Execute(LocalPluginContext localContext)
        {
            ...
            {
                throw new InvalidPluginExecutionException("Fault exception occured executing PostTaxiLicence: " + ex + ".");
            }
            catch (Exception ex)
            {
                throw new InvalidPluginExecutionException("An exception occured executing PostTaxiLicence: " + ex + ".");
            }
