    ...
    if (context.parameters.line1.raw) {
      useAddressStore.setState({
        address: {
          ...
          longitude: Number(context.parameters.longitude.raw) ?? 0,
          latitude: Number(context.parameters.latitude.raw) ?? 0,
          northing: Number(context.parameters.northing.raw) ?? 0,
          easting: Number(context.parameters.easting.raw) ?? 0,
